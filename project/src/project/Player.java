...
public class Player {
   		...
   		for(int i=0;i<vectorr.size();i++)
                   {
                      ...
                      System.out.println("avilable hours: from: "+vectorr.get(i).owner.get(i)+"->"+vectorr.get(i).owner.get(i+1)+"\n  cancleation: "+vectorr.get(i).getCancellation_period()+"\n");
   ...
   public void filterprice(int price_range) {
   	...
   	/**
   	 * booking playground by add slot time and playground name id its avaliable the system asked the player to pay 
